      ...
      <div className="articles-section">
        ...
        <div className="articles-container">
          <div className="article">
            <img src= "/assets/images/products/Warningsigns.jpg" alt="Warning Signs of Abuse" />
            <p>Warning Signs of Abuse</p>
          </div>
          <div className="article">
            <img src= "/assets/images/products/Healthyrelationships.jpg" alt="Healthy Relationships" />
            <p>Healthy Relationships</p>
          </div>
          <div className="article">
            <img src= "/assets/images/products/safetyplan.jpg" alt="Create a Safety Plan" />
